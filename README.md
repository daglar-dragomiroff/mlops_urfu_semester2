# Лабораторные работы по дисциплине "Автоматизация администрирования MLOps"
Работу выполнили студенты 1-го курса магистратуры "Инженерия машинного обучения" Уральского федерального университета:
- Драгомирский Радмил
- Шалагин Дмитрий
- Игорь Пластов
- Письмаров Михаил
